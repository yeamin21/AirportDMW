...
public class FlightSchedules {
    ...
    FlightSchedules(String code, String origin_airport, String destination_airport, String airline, String aircraft, String date1, String date2, float base_price) {
        this.code = code;
